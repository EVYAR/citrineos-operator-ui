...
ENV NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL \
    ...
    NEXT_PUBLIC_METRICS_URL=$NEXT_PUBLIC_METRICS_URL \
    NEXT_PUBLIC_DEFAULT_MAP_CENTER_LATITUDE=$NEXT_PUBLIC_DEFAULT_MAP_CENTER_LATITUDE \
    NEXT_PUBLIC_DEFAULT_MAP_CENTER_LONGITUDE=$NEXT_PUBLIC_DEFAULT_MAP_CENTER_LONGITUDE \
    NEXT_PUBLIC_GOOGLE_MAPS_LOCATION_PICKER_MAP_ID=$NEXT_PUBLIC_GOOGLE_MAPS_LOCATION_PICKER_MAP_ID \
    NEXT_PUBLIC_GOOGLE_MAPS_OVERVIEW_MAP_ID=$NEXT_PUBLIC_GOOGLE_MAPS_OVERVIEW_MAP_ID \
    GOOGLE_MAPS_API_KEY=$GOOGLE_MAPS_API_KEY \
    GOOGLE_MAPS_ADDRESS_API_KEY=$GOOGLE_MAPS_ADDRESS_API_KEY
